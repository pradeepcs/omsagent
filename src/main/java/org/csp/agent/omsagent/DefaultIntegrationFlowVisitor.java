...
class DefaultIntegrationFlowVisitor extends ClassAdapter implements Opcodes {
	public DefaultIntegrationFlowVisitor(ClassVisitor classvisitor) {
		super(classvisitor);
	}
	...
	public MethodVisitor visitMethod(int access, String name, String desc,
		...
		if (("invoke".equals(name))
				&& ("(Lcom/yantra/yfs/japi/YFSEnvironment;Ljava/lang/String;Lorg/w3c/dom/Document;)Lorg/w3c/dom/Document;"
						.equals(desc))) {
			return super.visitMethod(access, "invoke1", desc, signature,
					exceptions);
		}
